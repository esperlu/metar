...
Linux Raspberry RPi-1 (Zero, A, A+, B, B+) - 32-bit| arm v6 | [download](https://github.com/esperlu/metar/blob/master/binaries/linux/arm6/metar?raw=true)
Linux Raspberry RPi-2B 32-bit | arm v7 | [download](https://github.com/esperlu/metar/blob/master/binaries/linux/arm7/metar?raw=true)
